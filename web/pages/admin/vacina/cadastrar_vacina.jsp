        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    ...
                    <div>
                        <mtw:form action="admin/vacina.inserir.mtw" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <mtw:input type="text" name="descricao" size="30" maxlength="150" />
                            </div>
                            <div class="form-group">
                                <label>Lote</label>
                                <mtw:input type="text" name="lote" size="30" maxlength="30" />
                            </div>
