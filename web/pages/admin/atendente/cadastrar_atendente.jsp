                        ...
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group mr-2">
                                ...
                                <form action="/pesquisaPaciente" method="get" class="form-inline">
                                    <input class="form-control mr-sm-2" type="search" size="50" name="tfPesquisar" placeholder="Pesquisar atendentes" aria-label="Search" autofocus maxlength="120">
                                    <button class="btn my-2 btn-outline-secondary my-sm-0" type="submit"><i class="fas fa-search"></i></button>

                                </form>
                                <span>&nbsp</span>
                                <a class="btn btn-sm btn-outline-secondary" href="<mtw:contextPath/>/admin/atendente.cadastrar.mtw">Novo Atendente</a>

                            </div>
                        </div>
                    </div>
                    <div>
                        <mtw:form action="admin/atendente.inserir.mtw" method="post">
                            <div class="form-group">
                                <label>Nº Matricula</label>
                                <mtw:input type="text" name="matricula" size="30" maxlength="30" />
                            </div>
                            <div class="form-group">
                                <label>Nome</label>
